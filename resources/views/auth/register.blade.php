                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="Mail" class="form-control @error('Mail') is-invalid @enderror" name="Mail" value="{{ old('Mail') }}" required autocomplete="mail">
                        ...
                        <div class="form-group row">
                            <label for="NombreUsuario" class="col-md-4 col-form-label text-md-right">{{ __('NombreUsuario') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" name=telefonoe" value="{{ old('telefono') }}" required autocomplete="telefono" autofocus>
